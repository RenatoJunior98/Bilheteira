 ...
 * Contem os metodos da criação de janelas e o metodo start da aplicação
...
public class Main extends Application {
	...
	/**
	 * Método Start da classe Main
	 * É o primeiro metodo chamado quando iniciada a aplicação
	 * É criada a janela do MainStage
	 * Adiciona também um icon e o nome da aplicação 
	 */
	@Override
	...
	/**
	 * Método da criação de novas janelas 
	 * É chamado sempre que for necessário criar uma janela
